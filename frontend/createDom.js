...
export function createLeftContainer () {
  ...
  const button1 = createEl("button", {className:"add", id: "button1", type: "submit", textContent: "Add to cart" });
  ...
  const  button2 = createEl("button", {className:"add", id: "button2", type: "submit", textContent: "Add to cart" });
  ...
  const button3 = createEl("button", {className:"add", id: "button3", type: "submit", textContent: "Add to cart" });
  ...
  const button4 = createEl("button", {className:"add", id: "button4", type: "submit", textContent: "Add to cart" });
  ...
  const button5 = createEl("button", {className:"add", id: "button5", type: "submit", textContent: "Add to cart" });
  ...
  const button6 = createEl("button", {className:"add", id: "button6", type: "submit", textContent: "Add to cart" });
  ...
  const button7 = createEl("button", {className:"add", id: "button7", type: "submit", textContent: "Add to cart" });
...
export function createRightContainer() {
  ...
  const inputName = createEl("input", { id: "input-name", type: "text", placeholder: "Enter your name", name:"FullName"});
  const labelZip = createEl("label", { id: "label-zip", textContent: "Zip Code:"});
  const inputZip = createEl("input", { id: "input-zip", type: "text", placeholder: "Enter your zip code", name: "Zip-Code"});
  const labelCity = createEl("label", { id: "label-city", textContent: "City:"});
  const inputCity = createEl("input", { id: "input-city", type: "text", placeholder: "Enter your city", name:"City"});
  const labelStreet = createEl("label", { id: "label-street", textContent: "Street:"});
  const inputStreet = createEl("input", { id: "input-street", type: "text", placeholder: "Enter your street", name:"street"});
  const labelHouseNumber = createEl("label", { id: "label-number", textContent: "House Number:"});
  const inputHouseNumber = createEl("input", { id: "input-number", type: "text", placeholder: "Enter your House number", name:"Number"});
  const labelEmail = createEl("label", { id: "label-email", textContent: "Email:"});
  const inputEmail = createEl("input", { id: "input-email", type: "text", placeholder: "Enter your email",name:"e-mail"});
  const labelPhone = createEl("label", { id: "label-phone", textContent: "Phone Number:"});
  const inputPhone = createEl("input", { id: "input-phone", type: "text", placeholder: "Enter your phone number", name:"Phone"});
