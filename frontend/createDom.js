...
export function createLeftContainer () {
  ...
  const img1  = createEl("img", { id: "img1", src: "/coffees/pictures/1", });
  ...
  const img2 = createEl("img", { id: "img2", src: "/coffees/pictures/2",  });
  ...
  const img3 = createEl("img", { id: "img3", src: "/coffees/pictures/3", });
  ...
  const img4 = createEl("img", { id: "img4", src: "/coffees/pictures/4",  });
  ...
  const img5 = createEl("img", { id: "img5", src: "/coffees/pictures/5",  });
  ...
  const img6 = createEl("img", { id: "img6", src: "/coffees/pictures/6",});
  ...
  const img7 = createEl("img", { id: "img7", src: "/coffees/pictures/7",  });
